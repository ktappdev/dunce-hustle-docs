...
- **Typical match length:** 30 days (Long Form uses monthly season cadence)
...
A game finishes when its configured maximum day count is exceeded (usually day 30).
...
- Energy resets to max (with AFK penalties)
